...
async def load_tracked_satellites():
    ...
    with a short delay — a real, observed failure mode is the outbound
    connection not being fully ready in the first moment a cold-started
    free-tier instance wakes up, which a single attempt has no chance to
    recover from.
    """
