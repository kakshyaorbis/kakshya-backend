...
async def celestrak_group(group: str):
    ...
    try:
        ...
        def save_cache(data: str, is_error: bool, source: str):
            ...
            if existing:
                ...
                db.add(CelestrakCacheEntry(group_name=group, data=data, cached_at=now, is_error=is_error, source=source))
            db.commit()
        ...
        # substitute.
        save_cache(celestrak_error, True, "none")
        return JSONResponse(status_code=502, content={
